 ...
 * @author Adriano
 */
public class IncluirGrupo extends javax.swing.JFrame {
        
    Validacao v = new Validacao();
    /**
     * Creates new form IncluirGrupo
     */
    public IncluirGrupo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Incluir Grupo de Monitoramento");
        setName("Incluir Grupo de Monitoramento"); // NOI18N
        setResizable(false);

        jLabel1.setText("Nome:");

        jLabel2.setText("Número Sala:");

        jLabel3.setText("Código Sistema:");

        jLabel4.setText("CodSis");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncluirGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IncluirGrupo().setVisible(true);
            }
        });
    }
